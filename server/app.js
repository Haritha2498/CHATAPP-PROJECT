...
mongoose.connect(
    "mongodb://chatmongodb:27017/CHATAPPREACT"
)
...
const userdetails=require('./models/schema.js')
...
const usersprofile=require('./models/profile.js')
const userchats=require('./models/chatmsg.js')
const userblocklist=require('./models/blockusers.js')
